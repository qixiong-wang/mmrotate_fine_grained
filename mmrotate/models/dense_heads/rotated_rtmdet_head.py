...
@MODELS.register_module()
class RotatedRTMDetSepBNHead_lsk(RotatedRTMDetHead):
    """Rotated RTMDetHead with separated BN layers and shared conv layers.
    ...
    def __init__(self,
        ...
        self.lsknet = LSKNet(img_size=128, in_chans=256, embed_dims=[256, 256, 256], num_stages=3)
