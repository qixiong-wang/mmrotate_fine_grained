...
class OrientedStandardRoIHead(RotatedStandardRoIHead):
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels,
        ...
        bbox_results = self._bbox_forward(x, rois)
        from mmrotate.models.utils.eam import EMA
        ema = EMA(channels=bbox_results['bbox_feats'].size(1), num_classes=37)
        bbox_feats = ema.forward(bbox_results['bbox_feats'], bbox_results['bbox_pred'])
        bbox_results['cls_score'], bbox_results['bbox_pred'] = self.bbox_head(bbox_feats)
